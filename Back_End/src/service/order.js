  ...
  try {
    ...
    await getPrisma().notification.create({
      data: {
        ...
        longMessage: `Order with id ${orderId} has been updated. This order goes to ${data.orderCountry}, ${data.orderCity}, ${data.orderStreet} ${data.orderAddressNumber}. The order contains ${data.orderItems.length} items.`,
        companyId: data.companyId,
      },
    });
    return order;
